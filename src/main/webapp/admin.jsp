...
<html lang="en">
    ...
    <body class="goto-here">
        ...
        <div class="hero-wrap hero-bread" style="background-image: url('images/box.jpg');">
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        <p class="breadcrumbs"><span class="mr-2"><a href="home.html">Inicio</a></span> <span>Pedidos</span></p>
                        <h1 class="mb-0 bread">Mi lista de Pedidos</h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <c:forEach begin="0" end="${size}" step="1" var="i">
                                    <tbody><!--Inicio de Listado de productos con precios y cantidades-->
                                        <tr class="text-center">
                                            ...
                                            <td class="product-remove"><a href="${pageContext.request.contextPath}/AdminController?accion=validate&idPedido=${pedidos.get(i).idPedido}"><span class="ion-ios-arrow-down"></span></a></td>
                                        </tr><!-- END TR-->
                                    </tbody>
                                </c:forEach>
