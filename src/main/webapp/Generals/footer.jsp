        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">The Fruit Emporium</h2>
                    <p>Siempre frutas y verduras frescas de buena calidad, de la mano de la innovación.</p>
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="d-flex">
                        <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                            <li><a href="#" class="py-2 d-block">Información del Domicilio</a></li>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    ...
                    And <a href="www.clsma.com.co:8080/ClsmaPage-2.1" target="_blank">BNT SAS</a> &copy; 2020 
