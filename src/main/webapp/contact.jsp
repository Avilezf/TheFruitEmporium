...
<html lang="en">
    <head>
        <title>Contacto - TheFruitEmporium</title>
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        <p class="breadcrumbs"><span class="mr-2"><a href="${pageContext.request.contextPath}/ServletControlador?accion=home   ">Home</a></span> <span>Contact us</span></p>
        ...
        <section class="ftco-section contact-section bg-light">
            <div class="container">
                <div class="row d-flex mb-5 contact-info">
                    ...
                    <div class="col-md-3 d-flex">
                        <div class="info bg-white p-4">
                            <p><span>Telefono</span> <a href="tel://+57 300 401 9873">+57 300 401 9873</a></p>
                        </div>
                    </div>
                    <div class="col-md-3 d-flex">
                        <div class="info bg-white p-4">
                    ...
                    <div class="col-md-3 d-flex">
                        <div class="info bg-white p-4">
                            <p><span>Website</span> <a href="#">TheFruitEmporium.com.co</a></p>
                        </div>
                    </div>
                </div>
